...
function renderBankAccounts() {
    ...
    renderRecordsSection(nodes.bankAccounts, {
        ...
        emptyText: 'Добавьте расчётный счёт — он подставляется в шапку документов и в реквизиты для оплаты.',
...
function renderTaxes() {
    ...
    renderRecordsSection(nodes.taxes, {
        ...
        uiState: taxUiState,
        idPrefix: 'mTax',
        emptyTitle: 'Налоговых записей пока нет',
        emptyText: 'Добавьте систему налогообложения — она нужна в договорах и счетах.',
