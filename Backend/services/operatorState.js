...
const WORK_STATES = ['off', 'on_line', 'break', 'lunch', 'training', 'review'];

// Порядок и подписи для панели состояний. Пост-обработки здесь нет намеренно:
// это системное состояние, и возможность выбрать его руками была бы способом
// бесконечно не брать лидов.
