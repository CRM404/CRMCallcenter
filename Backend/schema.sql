...
CREATE TABLE IF NOT EXISTS calls (
    ...
    --
    -- ПИШУЩЕГО У КОЛОНКИ НЕТ НИ ОДНОГО, и это не про неё одну: `INSERT INTO
    -- calls` во всём проекте отсутствует, таблицу наполнит телефония (тот же
    -- довод стоит в routes/leads.js у непривязанной к звонку записи ленты).
