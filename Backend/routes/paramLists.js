// --- routes/paramLists.js: «Настройка списков» — 13 управляемых справочников
// форм оффера недвижимости и карточки лида (report_2026-08-01.md, Фаза 2,
// 07.08.2026; +2 ключа 14.08.2026).
// Одна общая таблица param_lists на все списки (архитектурное решение
// куратора — списки структурно одинаковы, отдельные таблицы дали бы
// 13-кратный дублирующийся CRUD без пользы). «Статус» сюда намеренно не
...
// decisionMaker и deadline поля в форме оффера НЕ имеют — они нужны карточке
// лида, но управляются той же панелью «Настройка списков» (иначе владелец не
// смог бы их редактировать, в отличие от всех остальных). Белый список тут
// обязателен: без ключа GET вообще не вернёт список, а POST/DELETE ответят
// «Неизвестный список».
const LIST_KEYS = [
    'category', 'actionType', 'leadCheck', 'objType', 'objClass', 'finish',
    'rooms', 'clientType', 'purchaseTerm', 'paymentMethod', 'mortgageType',
    'decisionMaker', 'deadline'
];
